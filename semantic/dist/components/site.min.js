...
e.extend(e.expr[":"],{data:e.expr.createPseudo?e.expr.createPseudo(function(n){return function(o){return!!e.data(o,n)}}):function(n,o,i){
// support: jQuery < 1.8
return!!e.data(n,i[3])}})}(jQuery,window,document);